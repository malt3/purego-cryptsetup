...
func Init(cd **CryptDevice, device *byte) int32 {
	return crypt_init_dl(cd, device)
}

func InitByName(cd **CryptDevice, name *byte) int32 {
	return crypt_init_by_name_dl(cd, name)
}
...
func Dump(cd *CryptDevice) int32 {
	return crypt_dump_dl(cd)
}
...
func Format(
	...
	return crypt_format_dl(cd, typ, cipher, cipher_mode, uuid, volume_key, volume_key_size, params)
}
...
func Wipe(
	...
	return crypt_wipe_dl(cd, dev_path, crypt_wipe_pattern, offset, length, wipe_block_size, flags, progress, usrptr)
}

func Resize(cd *CryptDevice, name *byte, new_size uint64) int32 {
	return crypt_resize_dl(cd, name, new_size)
}

func Load(cd *CryptDevice, requested_type *byte, params unsafe.Pointer) int32 {
	return crypt_load_dl(cd, requested_type, params)
}
...
func KeyslotAddByVolumeKey(
	...
	return crypt_keyslot_add_by_volume_key_dl(cd, keyslot, volume_key, volume_key_size, passphrase, passphrase_size)
}
...
func KeyslotAddByPassphrase(
	...
	return crypt_keyslot_add_by_passphrase_dl(cd, keyslot, passphrase, passphrase_size, new_passphrase, new_passphrase_size)
}
...
func Deactivate(cd *CryptDevice, name *byte) int32 {
...
func GetVolumeKeySize(cd *CryptDevice) int32 {
...
func TokenJSONGet(cd *CryptDevice, token uint32, json **byte) int32 {
	return crypt_token_json_get_dl(cd, token, json)
}

func TokenJSONSet(cd *CryptDevice, token uint32, json *byte) int32 {
	return crypt_token_json_set_dl(cd, token, json)
}

func TokenLUKS2KeyringGet(cd *CryptDevice, token uint32, params *TokenParamsLUKS2Keyring) int32 {
	return crypt_token_luks2_keyring_get_dl(cd, token, params)
}

func TokenLUKS2KeyringSet(cd *CryptDevice, token uint32, params *TokenParamsLUKS2Keyring) int32 {
	return crypt_token_luks2_keyring_set_dl(cd, token, params)
}

func TokenAssignKeyslot(cd *CryptDevice, token, keyslot uint32) int32 {
	return crypt_token_assign_keyslot_dl(cd, token, keyslot)
}

func TokenUnassignKeyslot(cd *CryptDevice, token, keyslot uint32) int32 {
	return crypt_token_unassign_keyslot_dl(cd, token, keyslot)
}

func TokenIsAssigned(cd *CryptDevice, token, keyslot uint32) int32 {
	return crypt_token_is_assigned_dl(cd, token, keyslot)
}

func TokenStatus(cd *CryptDevice, token uint32, typ **byte) int32 {
